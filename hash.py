...
def hash_password(password, salt=None):
    ...
    #we have to encode slat & password to utf-8, this is required by
    # the hashlib library.
    t_sh.update(salt.encode('uft-8') + password.encode('utf-8'))

    return salt + t_sh.hexdigest()
